...
public class MD5 {
	 ...
	 * If you want 32 bits MD5 password, change the code from
	 * "for(int i = 0; i<8; i++)" to "for(int i = 0; i < 16; i++)", and
	 * recompile this file, and change the length of password's column of table
	 * author.
	 * 
	 * @param str
	 *            input String for translate.
	 * @return the new String has been translated to MD5 of input string.
	 */
	public synchronized String getMD516(String str) {
	...
	public static void main(String[] args) {
		System.out.println(MD5.getInstance().Md5_32("111111"));
	}
}